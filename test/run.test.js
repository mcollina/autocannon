...
test('run', (t) => {
  run({
    ...
    t.type(result.latency.p25, 'number', 'latency.p25 (2.5%) exists')
    t.type(result.latency.p50, 'number', 'latency.p50 (50%) exists')
    t.type(result.latency.p975, 'number', 'latency.p975 (97.5%) exists')
    ...
    t.type(result.requests.p25, 'number', 'requests.p25 (2.5%) exists')
    t.type(result.requests.p50, 'number', 'requests.p50 (50%) exists')
    t.type(result.requests.p975, 'number', 'requests.p975 (97.5%) exists')
    t.type(result.requests.p99, 'number', 'requests.p99 (99%) exists')
    ...
    t.type(result.throughput.p975, 'number', 'throughput.p975 (97.5%) exists')
    t.type(result.throughput.p99, 'number', 'throughput.p99 (99%) exists')
...
test('run will exclude non 2xx stats from latency and throughput averages if excludeErrorStats is true', (t) => {
  ...
  run({
    ...
    t.equal(result.latency.p25, 0, 'latency.p25 (2.5%) should be 0')
    t.equal(result.latency.p50, 0, 'latency.p50 (50%) should be 0')
    t.equal(result.latency.p975, 0, 'latency.p975 (97.5%) should be 0')
    ...
    t.equal(result.throughput.p25, 0, 'throughput.p25 (2.5%) should be 0')
    t.equal(result.throughput.p50, 0, 'throughput.p50 (50%) should be 0')
    t.equal(result.throughput.p975, 0, 'throughput.p975 (97.5%) should be 0')
    t.equal(result.throughput.p99, 0, 'throughput.p99 (99%) should be 0')
