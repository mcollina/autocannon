...
function handleFinish (results, opts, cb) {
...
function run (opts, cb) {
  ...
  if (opts.useWorkers && isMainThread) {
    return initWorkers(opts, (results) => {
      handleFinish(results, opts, cb)
    })
  }

  return _run(opts, (err, results) => {
