...
Client.prototype._waitAndDestroy = function () {
  this.on('response', () => {
    this._requestCompleted()
  })
}

Client.prototype._requestCompleted = function () {
...
Client.prototype.destroy = function () {
  if (!this.destroyed) {
    ...
    if (!this.opts.waitAllResponses || !this.reqInProgress) {
      this.timeoutTicker.clear()
      this.emit('done')
      this._destroyConnection()
